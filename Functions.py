...
def movement_mainloop(player_obj, start, big_map):
    ...
    if keyboard.is_pressed("f"): player_obj.speed = player_obj.fast_speed
    if keyboard.is_pressed("ctrl"): player_obj.speed = player_obj.slow_speed
    if not keyboard.is_pressed("shift") and not keyboard.is_pressed("ctrl") : player_obj.speed = player_obj.normal_speed 
